...
log_level = 'INFO'
load_from = '/home/computervision_zl/Documents/retinanet/checkpoints/retinanet_r50_fpn_mstrain_3x_coco_20210718_220633-88476508.pth'
resume = False
...
model = dict(
    ...
    test_cfg=dict(
        ...
        max_per_img=100))
launcher = 'none'
work_dir = './work_dirs/retinanet_7'
